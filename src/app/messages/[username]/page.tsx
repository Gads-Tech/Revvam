...
export default function IndividualMessagePage() {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => loadConversation(conversationId, true), 2000);
