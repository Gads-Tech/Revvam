  ...
  return (
    <main className="min-h-screen bg-black px-5 py-8 pb-32 text-white sm:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mt-7"><p className="text-xs uppercase tracking-[0.22em] text-red-400/70">Social center</p><h1 className="mt-2 text-4xl font-black tracking-[-0.045em]">Notifications</h1><p className="mt-3 text-sm text-white/35">Followers, chat requests and message activity update automatically.</p></header>
