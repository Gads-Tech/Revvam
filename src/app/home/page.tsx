...
import { CarIcon, MessageIcon, PlusIcon, MoreIcon, SearchIcon, WarningIcon } from "@/components/icons";
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 pb-32 pt-6 sm:px-6 md:pb-16 md:pt-10 lg:px-8">
        <div className="mb-7 flex items-center justify-between md:hidden"><Logo href="/home" className="h-10 w-auto scale-[1.78] transform-gpu" /></div>
        ...
        <section className="mb-9 flex flex-wrap items-center gap-2"><QuickLink href="/profile/cars/add" icon={<CarIcon className="h-4 w-4" />} label="Add car" /><QuickLink href="/emergency" icon={<WarningIcon className="h-4 w-4" />} label="Emergency help" /><QuickLink href="/profile" icon={<MoreIcon className="h-4 w-4" />} label="My profile" /><span className="ml-1 hidden text-xs text-white/20 sm:inline">Build your garage, then get back to the feed.</span></section>
